...
class User(SqlAlchemyBase, UserMixin):
    ...
    temperature = sqlalchemy.Column(sqlalchemy.String, nullable=True, default='0')
    reaction = sqlalchemy.Column(sqlalchemy.String, nullable=True, default='0')
    sobriety = sqlalchemy.Column(sqlalchemy.String, nullable=True, default='0')
